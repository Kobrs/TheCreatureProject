...
class Simulation(object):
    def __init__(self, gravity=(0.0, 0.0), damping=1, engine_force=2000,
                 max_velocity=100, sensor_h=80, sensor_a=40, num_of_targets=5,
                 WIDTH=640, HEIGHT=480, iterations=1000, use_clock=True,
                 display=True):
        """
        ...
        :param use_clock: Decided whether to use pygame clock to maintain FPS
        """
    ...
    def mainloop(self):
        ...
        while running:
            ...
            if self.trackL_running is True:
                self.creature.apply_force_at_local_point(self.engine_force, self.trackL_center)

            if self.trackR_running is True:
                self.creature.apply_force_at_local_point(self.engine_force, self.trackR_center)
...
# sim = Simulation(WIDTH=1920, HEIGHT=1080, damping=0, engine_force=8, max_velocity=200)
sim = Simulation(WIDTH=640, HEIGHT=480, damping=0, engine_force=8, max_velocity=200, sensor_h=200, use_clock=True)
sim.mainloop()
