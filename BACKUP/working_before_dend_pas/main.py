...
def create_specimen():
    ...
    return "".join([str(np.random.randint(0, 2)) for _ in xrange(440)])
    # return DNA
...
def evaluate_specimen(DNA):
    ...
    score = spec.fitness_score(stimuli=stimuli, th=1), 
...
GA = ga.GA(mutate_rate=0.1, toursize=6, pop_size=50, CXPB=0.5, MUTPB=0.6)
